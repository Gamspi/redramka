    ...
    <div className="cards-list">
      ...
      <div className="cards-list__success">
        <TransitionGroup component="ul">
          {success.map(({name, id}) => (
            <CSSTransition timeout={500} key={id} classNames="success">
              <li>
                <Success name={name} />
              </li>
            </CSSTransition>
      ...
      <Confirm handelDelete={handelDelete} setIsConfirm={setIsConfirm} isConfirm={isConfirm} />
      <CSSTransition in={isInfo} timeout={1000} classNames="info" unmountOnExit mountOnEnter>
        <Info activeCard={activeCard.airline} isInfo={isInfo} setIsInfo={setIsInfo} setIsConfirm={setIsConfirm} />
      </CSSTransition>
        ...
        <TransitionGroup component="ul">
          {cards.map((element) => (
            <CSSTransition timeout={500} key={element._id} classNames="item">
              ...
              >
                <Card trips={element.trips} name={element.name} />
              </li>
            </CSSTransition>
          ))}
        </TransitionGroup>
